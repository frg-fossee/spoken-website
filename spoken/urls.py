...
urlpatterns = [
                  ...
                  url(r'^watch/([0-9a-zA-Z-+%\(\)., ]+)/([0-9a-zA-Z-+%\(\)., ]+)/([a-zA-Z-]+)/$', watch_tutorial,
                      name="watch_tutorial"),
                  ...
                  url(r'^admin/testimonials/(?P<rid>\d+)/edit/$', admin_testimonials_edit,
                      name="admin_testimonials_edit"),
                  url(r'^testimonials/new/media/(?P<testimonial_type>[\w]+)/$', testimonials_new_media,
                      name="testimonials_new_media"),
                  url(r'^admin/testimonials/(?P<rid>\d+)/delete/$', admin_testimonials_delete,
                      name="admin_testimonials_delete"),
                  url(r'^admin/testimonials/media/(?P<rid>\d+)/delete/$', admin_testimonials_media_delete,
                      name="admin_testimonials_media_delete"),
                  ...
                  url(r'^admin/testimonials/media/(?P<rid>\d+)/edit/$', admin_testimonials_media_edit,
                      name="admin_testimonials_media_edit"),
                  ...
                  url(r'^feedback_view/(?P<code>.+)/(?P<user_id>.+)/$', view_training_feedback,
                      name='view_training_feedback'),
                  url(r'^workshops/academic_details/$', academic_details, name='academic_details'),
                  url(r'^workshops/academic_details/(?P<state>.+)/$', academic_details_state,
                      name='academic_details_state'),
                  url(r'^resource_center_map_details/(?P<state>.+)/$', academic_details_state,
                      name='academic_details_state'),
